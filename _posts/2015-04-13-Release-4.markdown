...
<p>Hasta ahora habíamos propuesto la creación de una cuenta para poder hacer la reserva o la creación de un evento. Pero nos habíamos quedado ahí. Los usuarios no podían mostrar sus datos personales, sus intereses y gustos... y era hora de cambiar eso, y aportar un poco más de valor.</p>
...
<img src="{{ site.baseurl }}/img/05-workflow-perfiles.png" alt="workflow, perfil de usuario">![05-workflow-perfiles.png]({{site.baseurl}}/img/05-workflow-perfiles.png)

<span class="caption text-muted">Workflow, creación de perfil de usuario
.</span>

<h2 class="section-heading">Desarrollo de los perfiles</h2>

<p>También era importante que la edición del perfil fuera sencilla, por lo que pusimos especial cuidado en el formulario y priorizamos el requisito de que fuese accesible y fácil desde todos los dispositivos. Despues de varios diseños encontramos una solución a lo que buscábamos. </p>
