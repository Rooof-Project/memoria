...
<p>Según nuestros usuarios, la tarea más importante a realizar en la plataforma a través del móvil es “reservar un evento”. Según sus apreciaciones podrían darse estos casos:
<ul>
<li>1 Que algún amigo comparta en whatsapp un enlace al evento para ir juntos. </li>
<li>2 Un usuario que ha visto la versión desktop quiere enseñar con el móvil a qué evento va a ir a un amigo.</li>
<li>3 Un usuario que ha visto la versión desktop un evento que le interesa y, fuera de casa, quiere reservarlo.</li>
</ul>
</p>
