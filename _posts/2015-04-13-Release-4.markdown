...
<ul>
<li>el usuario no percibia bien que había reservado o creado un evento
<li>los usuarios consideraban importante ver la localización del evento en un mapa.
