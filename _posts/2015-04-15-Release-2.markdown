...
<p>Nos habían comunicado que iríamos a un laboratirio a hacer test de usuarios, nos pareció una buena oportinudad que debíamos aprobechar al máxima. Hasta ahora habíamos hecho muchos test de guerrilla, y algunos más cualitativos con amigos, pero no habíamos hecho una planificación más detallada de las pruebas. Nos propusimos tener finalizado el prototipo para testearlo en el laboratio.</p>
